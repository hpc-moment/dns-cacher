...
## Week 4
- [x] Есть `docs/protocols/PROTOCOL_WEEK4.md`
- [x] Сохранён лог `1.3.А` с DS-записью зоны и сравнением реального и локального IP
- [x] Сохранён лог `1.3.Б` с подменой адреса, сравнением флагов и ответами для поддоменов
- [x] Сохранён лог `1.3.В` со сбором реальных записей зоны и проверкой сгенерированного `local-zones.conf`
- [x] Сохранён лог `1.3.Г` с локальным ответом, статистикой и подтверждением отсутствия обращения к апстриму
- [x] Есть скриншот `1.3.А`
- [x] Есть скриншот `1.3.Б`
- [x] Есть скриншот `1.3.В`
- [x] Есть скриншот `1.3.Г`
